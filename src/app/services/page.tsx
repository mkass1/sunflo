...
const servicesJsonLd = {
  ...
  itemListElement: services.map((s, i) => ({
    ...
    item: {
      ...
      areaServed: { "@type": "City", name: "Fort Lauderdale", containedInPlace: { "@type": "State", name: "Florida" } },
      ...(s.pricing && {
        offers: [
...
export const metadata: Metadata = {
  title: "Auto Detailing Services & Pricing in Fort Lauderdale, FL",
  description:
    "Professional auto detailing, ceramic coatings, paint correction, PPF, and window tinting in Fort Lauderdale, FL. Serving South Florida since 2017. Packages from $120 — see full pricing.",
  alternates: { canonical: "/services" },
  openGraph: {
    title: "Auto Detailing Services & Pricing | Sunflo Detailing",
    description:
      "Interior detailing, paint correction, ceramic coatings, PPF, window tinting, and wraps. Serving Fort Lauderdale and South Florida since 2017.",
